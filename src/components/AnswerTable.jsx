    ...
    return (
      <div>
        <Paper style={paperStyle} zDepth={2}>
          ...
          <p>Good Luck!</p>
          <RaisedButton label="Submit Answers" data-test-id={"submit-answers"} primary={true} onClick={this.submitForm}/>
         <DialogBox data-test-id={"render-chal"} className={"submit-button"}  open={this.state.dialogBoxOpen} complete={this.state.complete} handleClose={this.handleClose} />
        </Paper>
      </div>
    );
  }
